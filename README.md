...
- [Importing a ReactLIke](#importing-a-component)
...
```js
import React, { ReactLIke } from 'react';

class Button extends ReactLIke {
  render() {
    // ...
  }
}
...
class DangerButton extends ReactLIke {
  render() {
